...
class LocationHelper {
  ...
  static Future<String?> getAddressFromCurrentLocation(
    ...
    try {
      LoggerHelper.info("Starting to check location permissions...");
                      ...
                      return ScaleTransition(
                        ...
                        child: AlertDialog(
                          ...
                          content: Column(
                            ...
                            children: [
                              const Text(
                                'You have permanently denied the location permission. Please enable it from the app settings to proceed.',
                                textAlign: TextAlign.right,
                                style: TextStyle(
                                  fontSize: 16,
      ...
      LoggerHelper.info("Getting current location...");
