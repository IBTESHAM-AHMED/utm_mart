                    ...
                    Container(
                      ...
                      child: const Row(
                        children: [
                          ...
                          Expanded(
                            child: Text(
                              'Please enable the location service in your device settings to continue',
                              textAlign: TextAlign.right,
                              style: TextStyle(
                                color: secondaryOrange,
                                fontSize: 16,
            ...
            return ScaleTransition(
              ...
              child: AlertDialog(
                ...
                content: const Column(
                  ...
                  children: [
                    Text(
                      'The app needs to access your location to provide better service and determine your delivery address.',
                      textAlign: TextAlign.right,
                      style: TextStyle(
                        fontSize: 16,
