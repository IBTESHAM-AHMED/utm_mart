...
import 'package:utmmart/core/network/dio_client.dart';
...
import 'package:utmmart/features/auth/domain/usecases/is_logged_in_usecase.dart';
...
import 'package:utmmart/features/shop/data/repository_impl/shop_firebase_repository_impl.dart';
...
Future<void> setupServiceLocator() async {
  ...
  sl.registerSingleton<AuctionFirestoreService>(AuctionFirestoreService());
  ...
  sl.registerSingleton<ShopRepo>(ShopFirebaseRepositoryImpl());
